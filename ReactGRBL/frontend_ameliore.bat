...
echo %BLUE%   (Version améliorée avec grille   %RESET%
echo %BLUE%    et point de position corrigés)  %RESET%
echo %BLUE%====================================%RESET%
echo.
...
echo.
echo %YELLOW%Améliorations apportées:%RESET%
echo %YELLOW%1. Correction de l'alignement du point bleu avec les axes%RESET%
echo %YELLOW%2. Ajout d'une croix et d'un point central pour plus de précision%RESET%
echo %YELLOW%3. Amélioration de l'affichage des coordonnées avec un fond%RESET%
echo.
